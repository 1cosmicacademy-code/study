# 📝 تمارين Lektion 3: Orte und Dinge

> 🎯 **الهدف:** اختبر نفسك في أدوات التعريف (der, die, das) وأسماء الأماكن والأشياء.  
> 💡 **نصيحة:** حاول تحل التمارين بنفسك أولاً، بعدين شوف الحل!

---

## التمرين 1: اختَر الأداة الصحيحة (der / die / das) 🎯
...
## التمرين 4: صنّف الكلمات حسب الجنس 📊

**ضع كل كلمة في العمود الصحيح (der / die / das):**
...
| # | العربية | الألمانية |
|---|---------|-----------|
| 1 | هذه حديقة. (Park) | ______________ |
| 2 | هذه مدرسة. (Schule) | ______________ |
| 3 | هذا بيت. (Haus) | ______________ |
| 4 | هذه لمبة. (Lampe) | ______________ |
| 5 | هذا كتاب. (Buch) | ______________ |
| 6 | هذه سينما. (Kino) | ______________ |
...
|---|--------------|--------|:-----:|
| 1 | 🏛️ مبنى كبير فيه كتب | Was ist das? (Bibliothek) | ______________ |
| 2 | 🏠 مبنى صغير تعيش فيه عائلة | Was ist das? (Haus) | ______________ |
| 3 | 🚂 فيه قطارات | Was ist das? (Bahnhof) | ______________ |
| 4 | 🛒 تشتري منه الأكل | Was ist das? (Supermarkt) | ______________ |
| 5 | 🎬 تشوف فيه أفلام | Was ist das? (Kino) | ______________ |
| 6 | 🛏️ تنام عليه | Was ist das? (Bett) | ______________ |
...
## التمرين 9: املأ الجملة بالصفة المناسبة 🎨

**اختر الصفة المناسبة من الصندوق:**
...
|---|--------|:--------------:|
| 1 | Der Park ist ____. (الحديقة جميلة) | ________ |
| 2 | Die Schule ist ____. (المدرسة كبيرة) | ________ |
| 3 | Das Haus ist ____. (البيت صغير) | ________ |
| 4 | Das Auto ist ____. (السيارة جديدة) | ________ |
| 5 | Der Tisch ist ____. (الطاولة قديمة) | ________ |
| 6 | Das Buch ist ____. (الكتاب جديد) | ________ |
...
|---------|---------|:----------:|
| 1 | اختيار der / die / das | ⬜ |
| 2 | ein أو eine | ⬜ |
| 3 | وصل الكلمات بالمعنى | ⬜ |
| 4 | تصنيف الكلمات حسب الجنس | ⬜ |
| 5 | ترجمة عربي ← ألماني | ⬜ |
| 6 | تصحيح خطأ (صحيح أم خطأ) | ⬜ |
| 7 | الإجابة عن Was ist das? | ⬜ |
| 8 | تكوين جملة كاملة | ⬜ |
| 9 | اختيار الصفة المناسبة | ⬜ |
| 10 | تصحيح الخطأ في الجمل | ⬜ |

> 🎉 **أحسنت!** إذا حلّيت كل التمارين، فأنت تعرف تستخدم der / die / das وتجاوب على سؤال **Was ist das؟** بثقة!
>
