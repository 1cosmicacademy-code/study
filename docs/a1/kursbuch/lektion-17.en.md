...
## 1. 💼 New Words (Neue Wörter) — Jobs and Duties
...
> 💡 **The difference:**
> - **Ich bin + Job** (Ich bin Lehrer) = I am + profession
> - **Ich arbeite als + Job** (Ich arbeite als Lehrer) = I work as + profession
...
1. Leila is a **doctor** (Ärztin).
2. Leila works **at the hospital** (im Krankenhaus).
3. Karim is a **programmer** (Programmierer).
4. Karim works **in a company** (in einer Firma).
5. Yes, Karim likes his work **very much** (sehr gern).
6. Leila says: She helps people — that's nice, but sometimes difficult.
7. Leila works **40 hours** per week.
8. Karim is free **on the weekend** (am Wochenende).
...
<div class="grammar-links">
  ...
  <a href="/grammatik/trennbare-verben/" class="grammar-btn">🇩🇪 Separable Verbs 🗂️</a>
