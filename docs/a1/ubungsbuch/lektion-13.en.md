# 📝 Exercises Lektion 13: Beim Arzt

> 🎯 **Goal:** Test yourself on body parts, pain, and the doctor in German.  
> 💡 **Tip:** Try to solve the exercises by yourself first, then check the answers!

---

## Exercise 1: Fill in the blank — Body Parts 🖊️
...
| 2 | You eat and talk with it. (mouth) | **________________** |
| 3 | You hear with it. (ear) | **________________** |
| 4 | You walk with it. (foot) | **________________** |
| 5 | You smell with it. (nose) | **________________** |
| 6 | You wear a ring on it. (finger) | **________________** |
...
| German | English |
|--------|---------|
| 1. der Hals | a. shoulder |
| 2. die Schulter | b. stomach / belly |
| 3. der Arm | c. neck / throat |
| 4. der Bauch | d. leg |
| 5. das Bein | e. arm |
| 6. der Rücken | f. knee |
| 7. das Knie | g. back |
...
## Exercise 4: Complete the sentence — Illnesses 🏥
...
| # | Sentence |
|---|----------|
| 1 | Ich habe _____________. (high temperature — 39°) |
| 2 | Ich habe _____________. (cough) |
| 3 | Ich habe _____________. (runny nose) |
| 4 | Ich habe _____________. (pain in the head — headache) |
...
## Exercise 5: Fill in the blanks — Doctor Dialogue 💬
...
| # | Arabic | German |
|---|--------|--------|
| 1 | My head hurts. | ______________ |
| 2 | I have a runny nose. | ______________ |
| 3 | My stomach hurts. | ______________ |
| 4 | I have a headache and a fever. | ______________ |
...
| # | Sentence | ✅ / ❌ |
|---|----------|:-------:|
| 1 | Ich habe **Fieber** = I have a cough. | |
| 2 | **Der Mund** = the mouth. | |
| 3 | **Meine Kopf** tut weh. (correct form) | |
| 4 | **Gute Besserung** = Get well soon. | |
| 5 | **Die Zähne** = the tooth (singular). | |
| 6 | **Ich habe Schmerzen** = I am in pain. | |
| 7 | **Das Bein** = the arm. | |
...
- Du **hast** Husten. — You have a cough.
- Er **hat** Kopfschmerzen. — He has a headache.
- Wir **haben** Halsschmerzen. — We have a sore throat.
- Ihr **habt** Schnupfen. — You (plural) have a runny nose.
- Sie **haben** eine Erkältung. — They / You (formal) have a cold.

---

## Exercise 9: Sentence Order 🧩
...
|----------|-------|:--------:|
| 1 | Body parts — Write the word | ⬜ |
| 2 | Match | ⬜ |
| 3 | mein / meine | ⬜ |
| 4 | Illnesses — Complete the sentence | ⬜ |
| 5 | Doctor dialogue | ⬜ |
| 6 | Translate Arabic → German | ⬜ |
| 7 | True or False | ⬜ |
| 8 | Conjugate haben | ⬜ |
| 9 | Sentence order | ⬜ |
| 10 | Translate German → English | ⬜ |
