# 📝 تمارين Lektion 11: Wohnen — السكن

> 🎯 **الهدف:** اختبر نفسك في حروف الجر المكانية ومفردات السكن والأثاث.  
> 💡 **نصيحة:** حاول تحل التمارين بنفسك أولاً، بعدين شوف الحل!

---

## التمرين 1: املأ الفراغ بحرف الجر المناسب 🖊️
...
| 2 | Die Katze schläft ___ dem Bett. (تحت) | **______** |
| 3 | Der Stuhl steht ___ dem Tisch. (بجانب) | **______** |
| 4 | Die Lampe hängt ___ der Decke. (على/معلق) | **______** |
| 5 | Das Auto ist ___ dem Haus. (أمام) | **______** |
| 6 | Der Garten ist ___ dem Haus. (خلف) | **______** |
| 7 | Das Bild hängt ___ der Wand. (على الحائط) | **______** |
| 8 | Der Tisch steht ___ dem Sofa und ___ dem Sessel. (بين) | **______** |
...
| # | Deutsch | # | Arabisch |
|---|---------|---|----------|
| 1 | Das Buch ist auf dem Tisch. | أ | القطة تحت السرير. |
| 2 | Die Katze ist unter dem Bett. | ب | المصباح بين الكنبة والكرسي. |
| 3 | Der Stuhl ist neben dem Tisch. | ج | السرير في غرفة النوم. |
| 4 | Die Lampe ist zwischen dem Sofa und dem Sessel. | د | الكتاب على الطاولة. |
| 5 | Das Bett ist im Schlafzimmer. | ه | الصورة على الحائط. |
...
| # | العربية | الألمانية |
|---|---------|----------|
| 1 | المفتاح في الحقيبة. | **__________________** |
| 2 | القطة تحت الطاولة. | **__________________** |
| 3 | الكرسي بجانب الباب. | **__________________** |
| 4 | المصباح على الطاولة. | **__________________** |
| 5 | السيارة أمام البيت. | **__________________** |
| 6 | الأطفال في الحديقة. | **__________________** |
...
## التمرين 8: اكتب عن غرفتك 🖊️🏠

**أكمل الجمل لتصف غرفتك (أو غرفة وهمية):**
...
**ارسم (أو تخيل) غرفة. اكتب 5 جمل تصف أين توجد الأشياء. استخدم حروف جر مختلفة.**
