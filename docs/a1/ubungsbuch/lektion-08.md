...
# 📝 Übungsbuch — Lektion 8: Party (Perfekt)

**الموضوع:** تمارين على الماضي المساعد (Perfekt) — موضوع الحفلة

**المستوى:** A1

---

## 🧩 تمرين 1: املأ الفراغ — haben oder sein؟

**اختر haben أو sein المناسبة:**
...
## 🧩 تمرين 3: ربط الجملة مع Partizip II
...
| 2. Wir haben Musik ... | (ب) | gekommen |
| 3. Er hat Cola ... | (ت) | gegangen |
| 4. Du bist um 9 Uhr ... | (ث) | gegessen |
| 5. Ihr seid nach Hause ... | (ج) | gehört |
| 6. Sie hat Pizza ... | (ح) | mitgebracht |
...
**ترجم الجمل التالية إلى الألمانية مستخدماً Perfekt:**

1. أنا احتفلت بعيد ميلادي أمس.
...
3. نحن رقصنا وغنينا معاً.

   → ___________________________________

4. هي لم تأتِ إلى الحفلة.
...
1. ❌ Ich **hat** gestern gefeiert.
   ...
   *(الخطأ: hat للغائب، مع ich نضع habe)*

2. ❌ Wir **sind** Pizza gegessen.
   ✅ Wir **haben** Pizza gegessen.
   *(الخطأ: essen يأخذ haben وليس sein)*

3. ❌ Er **hat** nach Hause gegangen.
   ✅ Er **ist** nach Hause gegangen.
   *(الخطأ: gehen (يذهب) حركة ← يأخذ sein)*

4. ❌ Du **bist** Kuchen gebacken.
   ✅ Du **hast** Kuchen gebacken.
   *(الخطأ: backen (يخبز) فعل عادي ← haben)*

5. ❌ Ihr **habt** zur Party gekommen.
   ✅ Ihr **seid** zur Party gekommen.
   *(الخطأ: kommen حركة ← sein)*

6. ❌ Sie haben viel **getanzen**.
   ✅ Sie haben viel **getanzt**.
   *(الخطأ: getanzen ليست صحيحة — الصحيح getanzt بدون n)*

</details>

---

## 🧩 تمرين 6: أعد كتابة الجمل في الماضي (Perfekt)
...
| 2. Tom kommt um 8 Uhr. | → ________________ |
| 3. Wir singen ein Lied. | → ________________ |
| 4. Lisa tanzt viel. | → ________________ |
| 5. Die Gäste trinken Saft. | → ________________ |
| 6. Du bringst Kuchen mit. | → ________________ |
...
## 🧩 تمرين 7: أسئلة وأجوبة

**أجب على الأسئلة التالية. استخدم الكلمات بين قوسين:**

1. **Hast du gestern gefeiert?** (ja, feiern)

   → ___________________________________

2. **Bist du zur Party gekommen?** (nein, nicht kommen)
...
4. **Hat Maria gesungen?** (ja, zwei Lieder)

   → ___________________________________

5. **Habt ihr getanzt?** (ja, viel)

   → ___________________________________

6. **Wer hat den Kuchen mitgebracht?** (meine Mutter, backen)
...
## 🧩 تمرين 8: رتب الكلمات لتكوين جملة

**رتب الكلمات التالية لتكوين جملة صحيحة في Perfekt:**
...
**أكمل الحوار بوضع الأفعال في Perfekt:**
...
## 🧩 تمرين 10: اكتب 3 جمل عن نفسك

**اكتب 3 جمل بالألمانية عن شيء فعلته في عطلة نهاية الأسبوع الماضي. استخدم Perfekt:**
...
<details>
<summary>✅ أمثلة للحلول</summary>

*(الإجابات ممكن أن تختلف — هذه أمثلة فقط)*

1. Am Wochenende **habe** ich Fußball **gespielt**.
2. Ich **bin** mit meiner Familie spazieren **gegangen**.
3. Wir **haben** zusammen Pizza **gegessen** und einen Film **gesehen**.
...
<div class="grammar-links">
  <a href="/grammatik/perfekt/" class="grammar-btn">🇩🇪 Perfekt (الماضي التام)</a>
