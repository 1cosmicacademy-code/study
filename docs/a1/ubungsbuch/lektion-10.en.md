# 📝 Lektion 10 Exercises: Bus und Bahn

> 🎯 **Goal:** Test yourself on means of transport, buying tickets, and asking for directions in German.  
> 💡 **Tip:** Try solving the exercises yourself first, then check the solutions!

---

## Exercise 1: Choose the correct answer 🚌

**Choose the right means of transport for each sentence:**

| # | Vehicle |
|---|---------|
| **A** | **der Bus** — the bus |
| **B** | **der Zug** — the train |
| **C** | **die U-Bahn** — the underground |
| **D** | **das Fahrrad** — the bicycle |
...
## Exercise 2: Fill in the blank — verb **fahren** 🚗
...
## Exercise 4: Fill in the blank — **mit** + vehicle 🚍
...
## Exercise 5: Translate from English to German 🌍
...
## Exercise 7: Read the train timetable 📋

**This is a train timetable from Frankfurt to Munich. Read it and answer the questions:**

| Train | Departure | Platform | Duration | Price |
|-------|-----------|----------|----------|-------|
| ICE 101 | 08:00 | Gleis 3 | 3 hours | 80 € |
| ICE 205 | 10:30 | Gleis 5 | 3 hours | 65 € |
...
## Exercise 10: Write a sentence about yourself ✏️

**Write a correct German sentence about the transport you use:**
...
| # | Example |
|---|---------|
| 1 | **Ich fahre mit dem Bus zur Schule.** or **Ich fahre mit dem Auto zur Arbeit.** |
| 2 | **Ich fahre mit der U-Bahn zum Markt.** or **Ich gehe zu Fuß zum Supermarkt.** (walking) |
| 3 | **Ich reise mit dem Flugzeug nach Deutschland.** or **Ich fahre mit dem Schiff in die Türkei.** |

> 💡 **Extra sentences you can use:**
> - **Ich gehe zu Fuß.** = I walk (no vehicle)
> - **Ich fahre mit dem Fahrrad.** = I go by bicycle
> - **Ich nehme den Bus.** = I take the bus (another way to say it)
...
| 2 | Conjugate fahren | ⬜ |
| 3 | Match sentences (tickets) | ⬜ |
| 4 | mit + Dative for vehicles | ⬜ |
| 5 | Translation English → German | ⬜ |
| 6 | Correct the mistake | ⬜ |
| 7 | Read the train timetable | ⬜ |
| 8 | Word order | ⬜ |
| 9 | Dialogue order | ⬜ |
| 10 | Write about yourself | ⬜ |

> 🎉 **Well done!** If you solved all the exercises, you can buy a train ticket, ask for directions, and talk about means of transport in German with confidence!
> 
