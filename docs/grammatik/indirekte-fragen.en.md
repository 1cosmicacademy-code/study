...
3. **With verbs of asking and thinking:**
...
```
Direct question:   Wo wohnt er?
Indirect question: Ich weiß nicht, wo er wohnt.
```

```
Direct question:   Wann kommt der Bus?
Indirect question: Können Sie mir sagen, wann der Bus kommt?
```
...
```
Direct question:   Kommt er heute?
Indirect question: Ich weiß nicht, ob er heute kommt.
```

```
Direct question:   Hast du Zeit?
Indirect question: Er fragt, ob ich Zeit habe.
```
...
| # | Sentence | Answer |
|---|----------|--------|
| 1 | Ich weiß nicht, _______ er wohnt. (where) | |
| 2 | Kannst du mir sagen, _______ der Film anfängt? (when) | |
| 3 | Er fragt, _______ wir morgen machen. (what) | |
| 4 | Ich habe keine Ahnung, _______ er nicht kommt. (why) | |
